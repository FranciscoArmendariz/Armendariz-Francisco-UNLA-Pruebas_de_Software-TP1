...
public class Posicion {
	...
	public boolean igualA(Posicion otraPosicion) {
		return ((this.getCoordenadaX() == otraPosicion.getCoordenadaX())
				&& (this.getCoordenadaY() == otraPosicion.getCoordenadaY()));
	...
	/**
	 * llamar dentro de getVecinoDeDistanciaMinima para mantener actualizada la
	 * lista de vecinos
	 */
	...
	// retorna una Posicion de un vecino con distancia minima a la Posicion de
	// Destino Final
